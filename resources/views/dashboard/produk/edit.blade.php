                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ old('nama_produk', $produks->nama_produk) }}" name="nama_produk">
                            </div>
                            <div class="mb-3">
                                <label>Tinggi :</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{ old('tinggi', $produks->tinggi) }}"
                                        name="tinggi">
                            ...
                            <div class="mb-3">
                                <label>Lebar :</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{ old('lebar', $produks->lebar) }}"
                                        name="lebar">
                                    <span class="input-group-text">cm</span>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('harga', $produks->harga) }}"
                                        name="harga">
                                </div>
                            </div>
